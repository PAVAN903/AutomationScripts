...
public class LinkedINLocators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.name("cppEmailOrUsername")).sendKeys("PAVAN");
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//div[text()='presentation']")).click();Thread.sleep(1000);
        ...
        driver.findElement(By.name("emailOrPhone")).sendKeys("PAVAN");
        driver.close();
